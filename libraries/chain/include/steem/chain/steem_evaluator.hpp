...
STEEM_DEFINE_EVALUATOR( owner_create )
STEEM_DEFINE_EVALUATOR( account_witness_vote )
STEEM_DEFINE_EVALUATOR( account_witness_weight_vote )
...
STEEM_DEFINE_EVALUATOR( subscribe )
STEEM_DEFINE_EVALUATOR( set_plan )
STEEM_DEFINE_EVALUATOR( remove_plan )
#ifdef STEEM_ENABLE_SMT
