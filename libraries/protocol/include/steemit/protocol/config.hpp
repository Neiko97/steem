...
#define STEEM_SYMBOL (uint64_t(3) | (uint64_t('E') << 8) | (uint64_t('F') << 16) | (uint64_t('T') << 24)| (uint64_t('G') << 32) )
#define SBD_SYMBOL (uint64_t(3) | (uint64_t('E') << 8) |(uint64_t('U') << 16) | (uint64_t('R') << 24))
