...
#define STEEM_INIT_SUPPLY                     (int64_t( 30 ) * int64_t( 1000000 ) * int64_t( 1000 )) //int64_t(0)
...
#define STEEM_MIN_ROOT_COMMENT_INTERVAL       (fc::seconds(3)) // 5 minutes
#define STEEM_MIN_REPLY_INTERVAL              (fc::seconds(3)) // 20 seconds
